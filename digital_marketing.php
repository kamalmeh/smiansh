...
<body>
    ...
    <section class="service_detail_sec common_padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="main_title mb-30">Digital Marketing</h4>
                    <p>Digital Marketing is the strongest approach to reach to new customers. This includes advertising using
                        all digital media such as Google AdSense, Social Media Marketing (Facebook, Instagram, Twitter etc),
                        YouTube Advertising and Email Marketing. This is the information age. You have carefully chosen your
                        digital content. Now it is time to market your products to all possible digital mediums. </p>
                    <p>At SMIANSH, we effectively market your products digitally in the form of advertisement, social media
                        sharing, and email marketing. As a result, you reach to your customers who can be your potential
                        clients. This activity helps to increase your revenues.</p>
