...
<body>
                ...
                <div class="col-md-12">
                    <div class="inner_header_info">
                        <div class="inner_heading">
                            <h2>Mobile Application and Development</h2>
                        </div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Mobile Application and Development</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <section class="service_detail_sec common_padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="main_title mb-30">Mobile Application and Development</h4>
                    <p>Mobile application development is very crucial for almost all businesses. People use mobiles every time
                        for everything. Therefore, having a mobile application for your business is necessary. It is really
                        very useful for digital marketing for your business. Mobile application gives a handy interface to
                        your users. They can access your business on their fingertips.</p>
                    <p>At SMIANSH, we develop a mobile application for Android and iOS at very cost-effective charges keeping
                        in mind of its user-friendliness. We keep it simple as we know simplicity is the key to success with
