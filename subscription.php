...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    $news = $offers = 1;
    $email = $_POST['email'];
    $sql = "CALL subscribeStp('" . $email . "'," . $news . "," . $offers . ")";
    ...
    if ($rs === true) {
        ...
        //$message=$email." has subscribed to Smiansh for latest news and Offers.";
        $message = '<p>Thank you for being part of Smiansh family and placing your trust and confidence in us.</p>
                        <p> We shall give the priority to you for our latest Offers.</p>';
        mail("contact@smiansh.com", "QUERY - " . $email, $message, "From: " . $email);
    } else {
        $message = $email . " has already subscribed to us. Congratulations!!!";
    }
}
?>
<html lang="en">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 ">
                        ...
                        <h2 class="construction_title">You have subscribed</h2>
                        <?php echo $message; ?>
                        <p>Stay Tuned...</p>
                        <img src="assets/image/under_con.png" alt="" class="under_con_img">
                    </div>
