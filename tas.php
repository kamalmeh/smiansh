...
<body>
                ...
                <div class="col-md-12">
                    <div class="inner_header_info">
                        <div class="inner_heading">
                            <h2>Talent Acquisation Service</h2>
                        </div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Talent Acquisation Service</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <section class="service_detail_sec common_padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="main_title mb-30">Talent Acquisation Service</h4>
