...
<body>
                ...
                <div class="col-md-12">
                    <div class="inner_header_info">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Portolio</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <!-- Portfolio Start -->
    <section class="portfolio_inner common_padding">
        <div class="container">
            ...
            <div class="row mb-50 wow fadeInUp">
                ...
                <div class="col-lg-6 col-md-12 align_center">
                    <div class="project_details ml-50">
            ...
            <!-- <div class="row">
                <div class="col-md-12 text-center mt-30">
                    <a href="portfolio.php" class="smiansh_btn">Load more</a>
                </div>
            </div> -->
        </div>
    </section>
