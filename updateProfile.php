...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    if (isset($_SESSION['user'])) {
        $sql = "SELECT * FROM UserTb where UserName='" . $_SESSION['email'] . "'";
        $result = $db->query($sql);
...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if ($missingValues == FALSE) {
            $sql = "UPDATE UserTb SET FirstName='" . $firstName . "', LastName='" . $lastName . "' WHERE UserName='" . $email . "'";
            $rs = $db->query($sql);
            if ($rs === true) {
                $_SESSION['user'] = $firstName;
                $_SESSION['email'] = $email;
            ...
            <div class="login-form">
                <div class="row just_cen">
                    <div class="col-lg-6 col-md-12">
                        <div class="my-form updateProfile wow zoomIn">
                            <!-- <img src="assets/image/user.png" class="title-img" alt="login"> -->
                            <i class="fa fa-user user_img"></i>
                            <!-- <span>Sign up</span> -->
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" name="updateProfile">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label>Email</label>
                                        <input readonly type="email" class="form-control" id="email" name="Email" value="<?php echo $email; ?>">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6 col-md-12">
                                        <label><a class="forgot-pwd" href="forgotPassword.php">Update Password</a></label>
                                    </div>
                                </div>
