...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    $sql = "SELECT * FROM UserTb WHERE UserName='" . $_POST['Email'] . "' and Password=PASSWORD('" . $_POST['Pass'] . "')";
    $records = $db->query($sql);
    if ($records->num_rows > 0) {
        $_SESSION['user'] = $records->fetch_assoc()['FirstName'];
        //$_SESSION['email'] = $records->fetch_assoc()['UserName'];
        $_SESSION['email'] = $_POST['Email'];
        // echo "Login Successful. Redirecting...";
        $_SESSION['id'] = session_id();
        $_SESSION['LAST_ACTIVITY'] = time();
        $sql = "UPDATE UserTb 
                    SET SessionID='" . $_SESSION['id'] . "', 
                        SessionActive='A',
                        SessionStart=now()
                        WHERE UserName='" . $_POST['Email'] . "'";
        if ($db->query($sql) === FALSE) {
            echo "There seems to be some issue, please try after sometime.";
        }
    } else {
        $errMsg = "<div class='error_msg'>Invalid Username/Password</div>";
    }
}
                            ...
                            <div class="my-form wow zoomIn">
                                ...
                                <form action="login.php" method="POST" name="login">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="Email" aria-describedby="emailHelp" placeholder="Username/Email" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="pwd">Enter Your Password</label>
                                        <input type="password" id="password-field" class="form-control" name="Pass" placeholder="Password" required>
                                    ...
                                    <div class="form-group">
                                        <div class="mt-20">
                                            ...
                                            <a class="forgot-pwd" href="forgotPassword.php">Forgot Password?</a>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="col-md-6 align_bottom">
                            <div class="footer_detail">
                                <ul class="main_list">
                                    ...
                                    <li>
                                        <div class="copyrightFooter">Copyright <span id="spanYear"> '.date('Y').'</span> © <strong>Smiansh</strong></div>
                                    </li>
                                </ul>
                            </div>
                        </div>
