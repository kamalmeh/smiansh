...
<body>
                ...
                <div class="col-md-12">
                    <div class="inner_header_info">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Brand Development</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <section class="service_detail_sec common_padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="main_title mb-30">Brand Development</h4>
                    <ul class="proper_list">
                        <li>Corporate Identity and Design</li>
                        <li>Content Writing</li>
                        <li>Logo design</li>
                        <li>Leaflet, Brochure Design</li>
