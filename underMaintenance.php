            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 ">
                        ...
                        <h2 class="construction_title">UNDER MAINTENANCE</h2>
                        <p>Thank you for being patient. We are investigating the issue and will be resolved shortly</p>

                        <button class="btn under_con_btn" type="submit">Report this Error</button>
