            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 ">
                        ...
                        <?php
                        if (!isset($_SESSION['ERROR_REPORTED'])) {
                            echo '<h2 class="construction_title">UNDER CONSTRUCTION</h2>
                                    <p>Thank you for being patient. This page is still under consutruction</p>
                                    <form method="POST" action="error.php" name="error_form">
                                    <input type="hidden" name="errorPage" value=' . $_SERVER['HTTP_REFERER'] . '>
                                    <button class="btn under_con_btn" name type="submit">Report this Error</button>
                                    </form>
                                    <p>We are coming with Something very exciting. Stay Tuned...</p>';
                        } else {
                            echo '<h2 class="construction_title">ERROR REPORTED</h2>
                                <p>Thank you for being patient. This will be resolved soon</p>';
                            unset($_SESSION['ERROR_REPORTED']);
                        }
                        ?>
                        <img src="assets/image/under_con.png" alt="" class="under_con_img">
                    </div>
